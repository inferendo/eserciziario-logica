...
#let exercise(cfg) = [
  ...
  #let enunciates_list = enunciates_tuples_list.at(1)
    ...
    Per ogni coppia ordinata $(x_n, x_(n+1))$: 1. formalizzare ogni enunciato 2. determinare se $(x_n, x_(n+1))$ siano contraddittori 3. determinare se formino un insieme coerente 4. determinare se il secondo enunciato sia conseguenza logica del primo tramite "$x_n models x_(n+1)$" oppure "$x_n cancel(models) x_(n+1)$".
